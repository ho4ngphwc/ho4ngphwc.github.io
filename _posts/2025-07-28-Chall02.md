...
![image](/assets/images/CTF/webhacking.kr/chall02/image1.png)

## Khai thác 

Đầu tiên mình cần check source của web này: 

![image](/assets/images/CTF/webhacking.kr/chall02/image2.png)

Tìm ra được 1 endpoint => `admin.php` 

![image](/assets/images/CTF/webhacking.kr/chall02/image3.png)
...
![image](/assets/images/CTF/webhacking.kr/chall02/image4.png)

Vậy trường này thì có thay đổi gì không ???

Ban đầu, chưa chỉnh sửa thì nó như này: 

![image](/assets/images/CTF/webhacking.kr/chall02/image5.png)

Nên mình sẽ thay đổi nó thành `2025` thử. 

![image](/assets/images/CTF/webhacking.kr/chall02/image6.png)
...
- Nếu inject `True` thì: 
![image](/assets/images/CTF/webhacking.kr/chall02/image7.png)

- Nếu inject `False` thì: 
![image](/assets/images/CTF/webhacking.kr/chall02/image8.png)
...
![image](/assets/images/CTF/webhacking.kr/chall02/image9.png)

![image](/assets/images/CTF/webhacking.kr/chall02/image10.png)
