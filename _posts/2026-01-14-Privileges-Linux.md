...
![image.png](/assets/img/redteam-privilegesLinux/image.png)
...
![image.png](/assets/img/redteam-privilegesLinux/image%201.png)

Thì giao diện như trên nên mình click vào thoai !! 

![image.png](/assets/img/redteam-privilegesLinux/image%202.png)
...
![image.png](/assets/img/redteam-privilegesLinux/image%203.png)
...
![image.png](/assets/img/redteam-privilegesLinux/image%204.png)

Mình thử truy cập **`uploads/healthcheck.php`** 

![image.png](/assets/img/redteam-privilegesLinux/image%205.png)
...
- Truyền tham số **`GET`**
    ...
    ![image.png](/assets/img/redteam-privilegesLinux/image%206.png)
    
    Mình vẫn thử truy cập như bình thường 
    
    ![image.png](/assets/img/redteam-privilegesLinux/image%207.png)
    
    Và mình tiến hành xem log trên server tại **`/var/log/apache2/access.log`** 
    
    ![image.png](/assets/img/redteam-privilegesLinux/image%208.png)
    

Cho nên mình chọn giải pháp truyền tham số **`REQUEST` → sẽ bao gồm cả `GET` và `POST`** 

![image.png](/assets/img/redteam-privilegesLinux/image%209.png)

Tiếp tục như trên mình truy cập như trên

![image.png](/assets/img/redteam-privilegesLinux/image%2010.png)

Và trên log nó ko để lại nhiều dấu vết như **`GET`** 

![image.png](/assets/img/redteam-privilegesLinux/image%2011.png)
...
![image.png](/assets/img/redteam-privilegesLinux/image%2012.png)
...
![image.png](/assets/img/redteam-privilegesLinux/image%2013.png)
...
![image.png](/assets/img/redteam-privilegesLinux/image%2014.png)
...
![image.png](/assets/img/redteam-privilegesLinux/image%2015.png)
...
![image.png](/assets/img/redteam-privilegesLinux/image%2016.png)
...
![image.png](/assets/img/redteam-privilegesLinux/image%2017.png)

Thì mình thấy nó có **`--checkpoint-action=ACTION`** vậy **`ACTION`** này gì?

Thì theo chatgpt như sau:

![image.png](/assets/img/redteam-privilegesLinux/image%2018.png)
...
![image.png](/assets/img/redteam-privilegesLinux/image%2019.png)

Như vậy nó in ra được **`123`** → thử ACTION exec 

![image.png](/assets/img/redteam-privilegesLinux/image%2020.png)

Như vậy hoàn toàn được lun :D 

Quay lại nội dung **`/etc/crontab`** 

![image.png](/assets/img/redteam-privilegesLinux/image%2021.png)

Thì mình thắc mắc là tại sao có **`*`** ?? 

Thì sau khi tìm hiểu thì nó là wildcard. Thử ví dụ như sau: 

![image.png](/assets/img/redteam-privilegesLinux/image%2022.png)

Vậy nếu mình tạo thử 1 file hay 1 folder có tên là các argument đặc biệt này thì nó có bị hiểu lầm hay ko :v  

![image.png](/assets/img/redteam-privilegesLinux/image%2023.png)
...
![image.png](/assets/img/redteam-privilegesLinux/image%2027.png)
...
![image.png](/assets/img/redteam-privilegesLinux/image%2028.png)

Như vậy mình xác định version là **`3.13.0`** 

2️⃣ **Dùng `searchsploit` để tìm kiếm**

![image.png](/assets/img/redteam-privilegesLinux/image%2029.png)

3️⃣ **Thực hiện leo quyền** 

![image.png](/assets/img/redteam-privilegesLinux/image%2030.png)

Sau đó mình upload file này và chạy.

![image.png](/assets/img/redteam-privilegesLinux/image%2031.png)
