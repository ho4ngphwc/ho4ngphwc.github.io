...
![image](/assets/images/WPT/path-traversal/image%201.png)

Mình thấy có nhiều hình ảnh. Nên sẽ thực hiện **`View`** thử.

![image](/assets/images/WPT/path-traversal/image%202.png)

Quan sát thì thấy nó nhận vào tên ảnh vào biến **`file_name`** 

Mình tiến hành review source code. 

![image](/assets/images/WPT/path-traversal/image%203.png)
...
![image](/assets/images/WPT/path-traversal/image%204.png)
...
![image](/assets/images/WPT/path-traversal/image%205.png)

Nó nhận vào **`images/flag.png`** qua tham số **`file`** 

Tiến hành review source code. 

![image](/assets/images/WPT/path-traversal/image%206.png)
...
![image](/assets/images/WPT/path-traversal/image%207.png)

## 🧪 Level 3

---

![image](/assets/images/WPT/path-traversal/image%208.png)
...
![image](/assets/images/WPT/path-traversal/image%209.png)

Tiến hành review source code.

![image](/assets/images/WPT/path-traversal/image%2010.png)
...
![image](/assets/images/WPT/path-traversal/image%2011.png)
...
![image](/assets/images/WPT/path-traversal/image%2012.png)

Sau đó mình truy cập vào file đã upload. 

![image](/assets/images/WPT/path-traversal/image%2013.png)

## 🧪 Level 4

---

![image](/assets/images/WPT/path-traversal/image%2014.png)

Đầu tiên mình cần nhập một username vào. 

![image](/assets/images/WPT/path-traversal/image%2015.png)

Tại **`Profile`** mình có chức năng **`Upload`** 

![image](/assets/images/WPT/path-traversal/image%2016.png)

Và tại phần **`Game`** 

![image](/assets/images/WPT/path-traversal/image%2017.png)
...
![image](/assets/images/WPT/path-traversal/image%2018.png)

Còn file **`profile.php`** 

![image](/assets/images/WPT/path-traversal/image%2019.png)

Nó nối chuỗi vào **`/var/www/html/upload/<session>/avatar.jpg`** 

Nghĩa là giờ mình upload file gì thì nó cũng sẽ là **`avatar.jpg`** 

![image](/assets/images/WPT/path-traversal/image%2020.png)

Mình quan sát tiếp file **`game.php`** 

![image](/assets/images/WPT/path-traversal/image%2021.png)

Quan sát thì mình đang ở **`views/`** 

Cho nên mình cần truyền payload như sau:

![image](/assets/images/WPT/path-traversal/image%2022.png)

## 🧪 Level 5

![image](/assets/images/WPT/path-traversal/image%2023.png)

---

![image](/assets/images/WPT/path-traversal/image%2024.png)

Tại đây mình có game và nó nhận file vào bằng biến **`game`** 

Mình tiến hành review source code. 

![image](/assets/images/WPT/path-traversal/image%2025.png)
...
![image](/assets/images/WPT/path-traversal/image%2026.png)

Nhưng làm sao để RCE thì trên server sẽ có nơi ghi lại log. Nên mình sẽ quan sát file này. 

![image](/assets/images/WPT/path-traversal/image%2027.png)

Và nhìn thấy nó viết lại mọi thứ kể cả **`User-Agent`** , mình thử truyền shell vào trường này.

![image](/assets/images/WPT/path-traversal/image%2028.png)

## 🧪 Level 6

---

![image](/assets/images/WPT/path-traversal/image%2029.png)

Ở level này ta được upload 1 file **`zip` .** Tiến hành đọc source code.

![image](/assets/images/WPT/path-traversal/image%2030.png)
...
![image](/assets/images/WPT/path-traversal/image%2031.png)
...
![image](/assets/images/WPT/path-traversal/image%2032.png)

Sau đó mình upload file này lên.

![image](/assets/images/WPT/path-traversal/image%2033.png)

Sau đó mình truy cập tới đường dẫn mình dùng payload.

![image](/assets/images/WPT/path-traversal/image%2034.png)