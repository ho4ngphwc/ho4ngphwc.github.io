...
![image](/assets/images/CTF/KCSCII/image1.png)

## YDSYD 

### Giao diện web 

![image](/assets/images/CTF/KCSCII/image2.png)
...
![image](/assets/images/CTF/KCSCII/image3.png)

Ở hàm này thực hiện `merge` mà ko có filtered.

Và có sẵn các user sau:

![image](/assets/images/CTF/KCSCII/image4.png)

Hàm tạo ra token 

![image](/assets/images/CTF/KCSCII/image5.png)

Khi mình gọi `POST login` thì nó sẽ thực hiện tạo token.

![image](/assets/images/CTF/KCSCII/image6.png)

![image](/assets/images/CTF/KCSCII/image7.png)

Sau đó, nó sẽ gọi tới hàm `authen` qua header 

![image](/assets/images/CTF/KCSCII/image8.png)
...
![image](/assets/images/CTF/KCSCII/image9.png)

Sau đó, gọi tới `/annyeong` với token được tạo ra.

![image](/assets/images/CTF/KCSCII/image10.png)

## ACL and H1 

### Giao diện web 

![image](/assets/images/CTF/KCSCII/image11.png)

**Upload Files**

![image](/assets/images/CTF/KCSCII/image12.png)

**My Files**

![image](/assets/images/CTF/KCSCII/image13.png)
...
![image](/assets/images/CTF/KCSCII/image14.png)

Đọc qua các file config của proxy thì như sau:

![image](/assets/images/CTF/KCSCII/image15.png)
...
![image](/assets/images/CTF/KCSCII/image16.png)

Và mình chỉ có thể upload được file `.txt` và `.html`

![image](/assets/images/CTF/KCSCII/image17.png)

### Khai thác 

Mình thử upload 1 file `.txt` có nội dung là: **&#123;&#123; 7*7 &#125;&#125;**

![image](/assets/images/CTF/KCSCII/image18.png)

Sau đó, mình gọi tới render file vừa upload xong. 

![image](/assets/images/CTF/KCSCII/image19.png)
...
![image](/assets/images/CTF/KCSCII/image20.png)
...
![image](/assets/images/CTF/KCSCII/image21.png)

## Vibe_coding

### Giao diện web 

![image](/assets/images/CTF/KCSCII/image22.png)

### Review Source Code 

![image](/assets/images/CTF/KCSCII/image23.png)

Mình có endpoint này để có đăng ký 1 user. 

![image](/assets/images/CTF/KCSCII/image24.png)

Và endpoint `/login` để sinh ra 1 token 

![image](/assets/images/CTF/KCSCII/image25.png)

Khi thực 1 action thì nó sẽ gọi tới sever python. 

![image](/assets/images/CTF/KCSCII/image26.png)
...
![image](/assets/images/CTF/KCSCII/image27.png)

![image](/assets/images/CTF/KCSCII/image28.png)

## Lost_Data_Prenvention 

### Giao diện web 

![image](/assets/images/CTF/KCSCII/image29.png)
...
![image](/assets/images/CTF/KCSCII/image30.png)

Ứng dụng cho phép search cái gì đó dựa trên `title`

**Attachments**

![image](/assets/images/CTF/KCSCII/image31.png)

Có thể là dùng để hiển thị trong table nào đó

**Export Logs**

![image](/assets/images/CTF/KCSCII/image32.png)
...
![image](/assets/images/CTF/KCSCII/image35.png)
...
![image](/assets/images/CTF/KCSCII/image36.png)
...
![image](/assets/images/CTF/KCSCII/image37.png)
...
![image](/assets/images/CTF/KCSCII/image38.png)

Sau đó, mình lấy flag thuiii 

![image](/assets/images/CTF/KCSCII/image39.png)

## CVE-2025-93XX 

### Giao diện web 

![image](/assets/images/CTF/KCSCII/image40.png)
...
![image](/assets/images/CTF/KCSCII/image41.png)
...
![image](/assets/images/CTF/KCSCII/image42.png)
