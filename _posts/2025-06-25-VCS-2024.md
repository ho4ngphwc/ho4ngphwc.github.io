...
![image](/assets/images/CTF/vcs-2024/image1.png)
...
![image](/assets/images/CTF/vcs-2024/image2.png)

![image](/assets/images/CTF/vcs-2024/image3.png)
...
![image](/assets/images/CTF/vcs-2024/image9.png)

Sau đó, mình truy cập vào id do ảnh mình đã upload thành công. 

![image](/assets/images/CTF/vcs-2024/image10.png)
...
![image](/assets/images/CTF/vcs-2024/image11.png)
...
![image](/assets/images/CTF/vcs-2024/image12.png)
...
![image](/assets/images/CTF/vcs-2024/image13.png)
...
![image](/assets/images/CTF/vcs-2024/image14.png)

Thì ở đây, mình có hai folder là `feedback` và `errors` có quyền write, và sticky bit.

![image](/assets/images/CTF/vcs-2024/image15.png)
...
![image](/assets/images/CTF/vcs-2024/image16.png)

**Thì mình có thể đặt ra là có bị SSTI hay ko ?**

![image](/assets/images/CTF/vcs-2024/image17.png)
...
![image](/assets/images/CTF/vcs-2024/image18.png)

![image](/assets/images/CTF/vcs-2024/image19.png)
...
![image](/assets/images/CTF/vcs-2024/image20.png)

### Khai Thác
![image](/assets/images/CTF/vcs-2024/image21.png)

Sau khi viết được thì mình được 1 tên file random.
![image](/assets/images/CTF/vcs-2024/image22.png)

Sau đó, mình truy cập qua tham số `error` để có thể render.
![image](/assets/images/CTF/vcs-2024/image23.png)
...
![image](/assets/images/CTF/vcs-2024/image24.png)
...
![image](/assets/images/CTF/vcs-2024/image25.png)

Sau đó login lại bằng tài khoản đó là username `<script>alert(origin)</script>`
![image](/assets/images/CTF/vcs-2024/image26.png)
